...
We believe human intention should not be owned by AI platforms, auctioned by centralized systems, or decided by black boxes.

Intent belongs to the one who declares it.

## What is OM World?

OM World is an open protocol for expressing, executing, and verifying human intentions.

AI provides the execution power.  
Crypto provides the rules, settlement, and verifiability.  
Humans retain sovereignty over their intentions.
